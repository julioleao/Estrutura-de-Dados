...
int menu4(int *opt){
	...
	printf("| [3] - Encontrar um elemento              |\n");
...
int menuQueueDouble(int *opt){
	...
	printf("| [ 5] - Remover do inicio                  |\n");
	printf("| [ 6] - Remover do fim                     |\n");
	printf("| [ 7] - Verificar ordenacao decrescente    |\n");
	printf("| [ 8] - Primeiro numero par                |\n");
	printf("| [ 9] - Ultimo numero par                  |\n");
	printf("| [10] - Comparar duas filas                |\n");
	printf("| [ 0] - Sair	    	                    |\n");
	printf("+-------------------------------------------+\n");
	printf("\nInforme uma opcao: ");
	scanf("%d", opt);
