...
// Função para inserir dados às structs
void insertData(reg people[]){
...
// Função menu escolha de ordenação
int ordenation(){
	int opt;
	printf("[1] Crescente\n");
